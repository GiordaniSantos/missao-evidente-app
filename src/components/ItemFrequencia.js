...
export default props => {
    resultadoData = props.updated_at.split(" ")
                ...
                <View style={styles.container}>
                    <View style={styles.cheackContainer}>
                        <View style={styles.done}>
                            <IconCheck name={props.icon} size={17} color='#FFF'></IconCheck>
                        </View>
                    </View>
                    <View>
                        <Text style={styles.desc}>{props.textoAntesQtd} {props.quantidade}</Text>
                        <Text style={styles.date}>Última Atualização: {resultadoData[0]} às {resultadoData[1]}h</Text>
